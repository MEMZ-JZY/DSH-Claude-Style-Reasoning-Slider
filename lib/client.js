      ...
      <style>
        ...
        *, *::before, *::after {
        ...
        .track-rim {
          ...
          -webkit-mask: radial-gradient(ellipse, transparent 0%, transparent calc(100% - 7px), #000 calc(100% - 3px), #000 100%);
          mask: radial-gradient(ellipse, transparent 0%, transparent calc(100% - 7px), #000 calc(100% - 3px), #000 100%);
          opacity: calc(var(--light-strength, 0) * 0.5);
          transition: opacity 180ms ease-out;
        }
