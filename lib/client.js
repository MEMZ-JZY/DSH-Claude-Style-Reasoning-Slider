      ...
      <style>
        ...
        *, *::before, *::after {
        ...
        .track-outline {
          ...
          -webkit-mask: radial-gradient(ellipse, transparent 0%, transparent calc(100% - 8px), #000 calc(100% - 3px));
          mask: radial-gradient(ellipse, transparent 0%, transparent calc(100% - 8px), #000 calc(100% - 3px));
          opacity: calc(var(--light-strength, 0) * 0.85);
          pointer-events: none;
          transition: opacity 180ms ease-out;
        }
